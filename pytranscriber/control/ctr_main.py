...
class Ctr_Main():
    ...
    def __initGUI(self):
        ...
        userHome = Path.home()
        # pathOutputFolder = userHome / 'Desktop' / 'Transcription'
        pathOutputFolder = 'C:\\xampp\\htdocs\\miniproject\\pyTranscriber-1.3-stable\\transcripts'
    ...
    def __listenerBExec(self):
        if not MyUtil.is_internet_connected():
            self.__showErrorMessage("Error! You need to have internet connection to Transcribe!!")
        else:
    ...
    def __listenerBLicense(self):
        self.__showInfoMessage("<html><body>1.N.Sathvik Rao 2.Saketh 3.Ganesh 4.Ravi</body></html>")

    def __listenerBAboutpyTranscriber(self):
        self.__showInfoMessage("<html><body>We used Google Speech to Text API to transcribe</body></html>", "About the Transcriber")
